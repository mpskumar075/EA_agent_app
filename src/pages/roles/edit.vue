                        ...
                        <div class="col-12 col-md-auto ">
                            <div class="">
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">{{ $t('edit_roles') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9 col-12">
                                                                <ValidationProvider :rules="{}" :name="$t('role_name')" v-slot="{ errors, invalid, validated }">
                                                                    <q-input outlined dense  ref="ctrlrole_name" rows="5"  v-model="formData.role_name" :placeholder="$t('enter_role_name')"    type="textarea"  :error="invalid && validated" :error-message="errors[0]">
                                                                    </q-input>
                                                                </ValidationProvider>
                                                            </div>
                                                        </div>
