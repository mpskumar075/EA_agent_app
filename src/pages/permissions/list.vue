                        ...
                        <div class="col-12 col-md-auto ">
                            <div class="">
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">{{ $t('permissions') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <template v-slot:body="props">
                                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                        ...
                                                        <q-td  key="role_id" :props="props">
                                                            <q-btn v-if="props.row.role_id" @click="openPageDialog({ page: 'roles/view', url: `/roles/view/${props.row.role_id}` }, { closeBtn: true })" padding="xs" color="blue-1" unelevated text-color="blue" no-caps >
