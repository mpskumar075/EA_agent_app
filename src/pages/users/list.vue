                                                ...
                                                <template v-slot:body="props">
                                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                        ...
                                                        <q-td  key="user_id" :props="props">
                                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/users/view/${props.row.user_id}`">{{ props.row.user_id }}</q-btn>
                                                        </q-td>
                                                        ...
                                                        <q-td  key="irda_code" :props="props">
                                                            {{ props.row.irda_code }}
                                                        </q-td>
                                                        ...
                                                        <q-td  key="user_role_id" :props="props">
                                                            <q-btn v-if="props.row.user_role_id" @click="openPageDialog({ page: 'roles/view', url: `/roles/view/${props.row.user_role_id}` }, { closeBtn: true })" padding="xs" color="blue-1" unelevated text-color="blue" no-caps >
                                                                <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  {{ $t('roles') }}
                                                            </q-btn>
                                                        </q-td>
                                                                ...
                                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                        <q-list dense rounded nav>
                                                                            <q-item link clickable v-ripple :to="`/users/view/${props.row.user_id}`">
                                                                                <q-item-section>
                                                                                    <q-icon color="primary"  size="sm" name="visibility"></q-icon>
                                                                                </q-item-section>
                                                                                <q-item-section>{{ $t('view') }}</q-item-section>
                                                                            </q-item>
                                                                            <q-item link clickable v-ripple :to="`/users/edit/${props.row.user_id}`">
                                                                                <q-item-section>
